...
function getCPU(callback) {
  request.get({
      url: 'http://192.168.99.100:31068/api/v1/query?query=stats_parser_cpu_usage_milli_cores'
    },
...
function getMemory(callback) {
  request.get({
      url: 'http://192.168.99.100:31068/api/v1/query?query=stats_parser_memory_usage_bytes'
    },
    function (err, httpResponse, body) {
...
function getPods(callback) {
  request.get({
      url: 'http://192.168.99.100:31068/api/v1/query?query=stats_parser_num_active_pods'
    },
    function (err, httpResponse, body) {
