var model = {
  "default": {
    ...
    "memoryTresholdPercent": 70, // percent of memoryTresholdPercent limit applied
    "upperResponseTimeTresholdSeconds": 2,
    "lowerResponseTimeTresholdSeconds": 1,
    "metricsAnalysisLevel": "high", // Should we spin down mulitple pods and how often should we check for changes - how reactive the policy should be
  },
  "overrides": [{
    "days": ["Mon", "Tues"],
    "timeFrom": "18:00",
